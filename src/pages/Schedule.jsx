      ...
      <div className="content-block">
        <div className="content-block__container">
          <div className="text-block"><div className="rte">
            ...
            <p>All times are in Central European Summer Time (CEST, UTC+2). The workshop takes place at the <strong>Strasbourg Convention Center, France</strong>. Room: TBA.</p>
          </div></div>
        </div>
      </div>
