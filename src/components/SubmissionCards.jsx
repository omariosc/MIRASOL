      ...
      <div className="content-block__container">
        <div className="focus-cards">
          ...
          <div className="focus-card -icon-inline">
            ...
            <p>
              As a jury member, you will have a crucial role in evaluating,
              encouraging, and empowering students who are applying machine
              learning and medical imaging to address urgent challenges in Low-
              and Middle-Income Countries (LMICs) and other underserved areas.
            </p>
            <div
              style={{
                marginTop: "auto",
            ...
            >
              <a
                className="action-element -primary"
                href="mailto:info.camera.mri@gmail.com"
              >
                Contact Us to Join
              </a>
            </div>
